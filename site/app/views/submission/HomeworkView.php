...
class HomeworkView extends AbstractView {
    ...
    public function showGradeable(Gradeable $gradeable, $graded_gradeable, int $display_version, bool $can_inquiry, array $students_full, bool $is_valid, array $count_array, array $files, $id, bool $show_hidden_testcases = false) {
        $return = '';
        ...
        if ($gradeable->isTaGradeReleased()
            ...
            && $submission_count !== 0
            && $active_version !== 0) {
            $return .= $this->renderTAResultsBox($graded_gradeable, $regrade_available, $id);
        }
