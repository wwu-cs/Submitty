    ...
    public function showHomeworkPage($gradeable_id, $gradeable_version = null) {
        ...
        if (!$this->core->getUser()->accessGrading() && (
            ...
            if (!$gradeable->hasAutogradingConfig()) {
                ...
                $this->core->getOutput()->renderOutput(array('submission', 'Homework'), 'showGradeable', $gradeable, $graded_gradeable, $version, $can_inquiry ?? false, $students_full, $is_valid, $count_array, $files, $id, $show_hidden);
