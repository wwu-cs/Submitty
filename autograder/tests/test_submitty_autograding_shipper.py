...
""")
        ...
        course_form_config_file = os.path.join(course_dir, "config", "form", "form_hw01.json")
        with open(course_form_config_file, 'w') as open_file:
            open_file.write("""
{
    "gradeable_id": "hw01",
    "config_path": "/var/local/submitty/private_course_repositories/test_course/hw01",
...
""")
        ...
        expected = "SHIPPER CHECKOUT VCS REPO  /home/carmpr/Documents/github/Submitty/autograder/tests/data/shipper_config.json\n"
...
/usr/bin/git clone git@gitlab.cs.wallawalla.edu:test_student/student141.git /home/carmpr/test_suite/unitTests/autograder/test_environment/autograding/courses/test_term/test_course/checkout/hw01/test_student/11/tmp --depth 1 -b master
